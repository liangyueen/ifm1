...
import nc.vo.ifm.util.QueryUtil;
...
public abstract class CommonListQueryAction<T extends AbstractBill> extends
	...
	public Object doAction(IRequest request) {
		...
		doAfter();
		// 构建返回前端结果
		Map<String, Object> result = this.buidFontResult(allPks, resultVOs,queryParam,groupData);
		// 处理精度
		processDigit();
		return result;
	}
	...
	private Grid convert(PageQueryVO result, int size, QueryTreeFormatVO queryParam) {
