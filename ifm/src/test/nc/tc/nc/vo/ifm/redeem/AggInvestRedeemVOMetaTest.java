...
import nc.vo.ifm.redeem.AggInvestRedeemVOMeta;
import nc.bs.framework.common.NCLocator;
import com.yonyou.uat.framework.BaseTestCase;
public class AggInvestRedeemVOMetaTest extends BaseTestCase {
  AggInvestRedeemVOMeta aggInvestRedeemVOMeta=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggInvestRedeemVOMeta=NCLocator.getInstance().lookup(AggInvestRedeemVOMeta.class);
  }
