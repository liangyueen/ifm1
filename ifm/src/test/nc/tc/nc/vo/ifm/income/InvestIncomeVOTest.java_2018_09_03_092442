...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class InvestIncomeVOTest extends BaseTestCase {
  InvestIncomeVO investIncomeVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    investIncomeVO=NCLocator.getInstance().lookup(InvestIncomeVO.class);
  }
  ...
  public void getVdef8(  Map<String,ArrayList<String>> dp){
    ...
    String retObj="";
    retObj=investIncomeVO.getVdef8();
  ...
  public void getVdef9(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getVdef9();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getOlcmoeny(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getOlcmoeny();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setOlcmoeny(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String olcmoeny=(String)dp.get("olcmoeny").get(0);
    
    //Invoke tested method
    investIncomeVO.setOlcmoeny(olcmoeny);
  ...
  public void getGlcmoeny(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getGlcmoeny();
  ...
  public void setGlcmoeny(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setGlcmoeny(glcmoeny);
  ...
  public void getGllmoeny(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getGllmoeny();
  ...
  public void setGllmoeny(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setGllmoeny(gllmoeny);
  ...
  public void getProductcode(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getProductcode();
  ...
  public void setProductcode(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setProductcode(productcode);
  ...
  public void getProductname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getProductname();
  ...
  public void setProductname(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setProductname(productname);
  ...
  public void getIssuebank(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getIssuebank();
  ...
  public void setIssuebank(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setIssuebank(issuebank);
  ...
  public void getBillstatus(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    Integer retObj=0;
    retObj=investIncomeVO.getBillstatus();
  ...
  public void setBillstatus(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setBillstatus(billstatus);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getGathering(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getGathering();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setGathering(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String gathering=(String)dp.get("gathering").get(0);
    
    //Invoke tested method
    investIncomeVO.setGathering(gathering);
  ...
  public void getInvestaccount(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getInvestaccount();
  ...
  public void setInvestaccount(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setInvestaccount(investaccount);
  ...
  public void getInterestday(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    Integer retObj=0;
    retObj=investIncomeVO.getInterestday();
  ...
  public void setInterestday(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setInterestday(interestday);
  ...
  public void getExpectedrate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getExpectedrate();
  ...
  public void setExpectedrate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setExpectedrate(expectedrate);
  ...
  public void getExpectedmoney(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getExpectedmoney();
  ...
  public void setExpectedmoney(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setExpectedmoney(expectedmoney);
  ...
  public void getEnddate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    UFDate retObj=null;
    retObj=investIncomeVO.getEnddate();
  ...
  public void setEnddate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setEnddate(enddate);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getActualmoeny(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    Boolean retObj=true;
    retObj=investIncomeVO.getActualmoeny();
    
    //Verify result is ok
    
    //Verify Object1 == Object2
    Assert.assertTrue(retObj);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setActualmoeny(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    Boolean actualmoeny=Boolean.parseBoolean(dp.get("actualmoeny").get(0));
    
    //Invoke tested method
    investIncomeVO.setActualmoeny(actualmoeny);
  ...
  public void getIncomerate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getIncomerate();
  ...
  public void setIncomerate(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setIncomerate(incomerate);
  ...
  public void getIncomemoney(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    String retObj="";
    retObj=investIncomeVO.getIncomemoney();
  ...
  public void setIncomemoney(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    investIncomeVO.setIncomemoney(incomemoney);
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=investIncomeVO.getMetaData();
